...
func (i *Source) PostSourceID(db *sql.DB) error {
	...
	err := db.QueryRow(
		"INSERT INTO source(source_id, date, file_name, sha1, line, source, proxy, wfstatus) VALUES($1, $2, $3, $4, $5, $6, $7, $8) ON CONFLICT (source_id) DO UPDATE SET (source_id, date, file_name, sha1, line, source, proxy, wfstatus) = ($1, $2, $3, $4, $5, $6, $7, $8) WHERE source.source_id = $1 RETURNING id",
