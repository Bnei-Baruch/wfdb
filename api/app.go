...
func (a *App) initializeRoutes() {
	...
	// Archive
	a.Router.HandleFunc("/archive/{id:[\\w-]+\\.[\\w]+}", a.PostArFile).Methods("PUT")
	a.Router.HandleFunc("/archive/{id:[\\w-]+\\.[\\w]+}", a.UpdateArFile).Methods("POST")
	a.Router.HandleFunc("/archive/{id:[\\w-]+\\.[\\w]+}", a.GetArFile).Methods("GET")
	a.Router.HandleFunc("/archive/{id:[\\w-]+\\.[\\w]+}", a.DeleteArFile).Methods("DELETE")
	...
	a.Router.HandleFunc("/convert/{id:[a-z][0-9]+}", a.GetConvertByID).Methods("GET")
	...
	// Carbon
	a.Router.HandleFunc("/carbon/{id:[\\w-]+\\.[\\w]+}", a.PostCarbonFile).Methods("PUT")
	a.Router.HandleFunc("/carbon/{id:[\\w-]+\\.[\\w]+}", a.GetCarbonFile).Methods("GET")
	a.Router.HandleFunc("/carbon/{id:[\\w-]+\\.[\\w]+}", a.DeleteCarbonFile).Methods("DELETE")
	a.Router.HandleFunc("/carbon", a.GetCarbonFiles).Methods("GET")
	a.Router.HandleFunc("/carbon/find", a.FindCarbonFiles).Methods("GET")
	// Kmedia
	a.Router.HandleFunc("/kmedia/{id:[\\w-]+\\.[\\w]+}", a.PostKmFile).Methods("PUT")
	a.Router.HandleFunc("/kmedia/{id:[\\w-]+\\.[\\w]+}", a.GetKmFile).Methods("GET")
	a.Router.HandleFunc("/kmedia/{id:[\\w-]+\\.[\\w]+}", a.DeleteKmFile).Methods("DELETE")
